...
(function () {
        ...
        return {
            define: function (b, d) {
                ...
                if (o.getListenerIndex(d) < 0) {
                    ...
                    i.fn = d;
                    i.priority = n;
                    for (var q = o.length - 1; q >= 0; q--)if (o[q].priority <= n) {
                        o.splice(q + 1, 0, i);
            ...
            once: function () {
                ...
                return function (n, i, k) {
                    ...
                    if (o) {
                        var q = o.listeners;
                        if (q.length)for (var q = q.slice(0), u, g = 0; g < q.length; g++) {
                            if (o.errorProof)try {
                                u = q[g].call(this,
                                    k, i, d, b)
                            } catch (p) {
                            } else u = q[g].call(this, k, i, d, b);
    ...
    (function () {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            moveChildren: function (a, f) {
                ...
                if (b != a) {
                    var c;
                    if (f)for (; c = b.lastChild;)a.insertBefore(b.removeChild(c),
            ...
            getDocumentPosition: function (a) {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    var o = this.$.getBoundingClientRect(), s = e.$.documentElement, q = s.clientTop || i.$.clientTop || 0, u = s.clientLeft || i.$.clientLeft || 0, g = true;
                    if (CKEDITOR.env.ie) {
            ...
            scrollIntoParent: function (a, b, c) {
                ...
                k = a.getWindow();
                i = q(this, k);
                var p = q(a, k), z = this.$.offsetHeight;
                e = this.$.offsetWidth;
                var A = a.$.clientHeight, m = a.$.clientWidth;
            ...
            copyAttributes: function (a, b) {
                for (var c = this.$.attributes, b = b || {}, e = 0; e < c.length; e++) {
                    ...
                    if (!(k in b))if (k == "checked" && (o = this.getAttribute(k)))a.setAttribute(k, o); else if (i.specified || CKEDITOR.env.ie && i.nodeValue &&
                        k == "value") {
            ...
            find: function (b) {
                var f = a(this), b = new CKEDITOR.dom.nodeList(this.$.querySelectorAll(e(this, b)));
                f();
                return b
            },
            findOne: function (b) {
    ...
    (function () {
        function a(a, b) {
            ...
            g = c.endContainer;
            var f = c.startOffset, e = c.endOffset, o, j = this.guard, l = this.type, v = a ? "getPreviousSourceNode" : "getNextSourceNode";
            if (!a && !this._.guardLTR) {
                var h = g.type == CKEDITOR.NODE_ELEMENT ? g : g.getParent(), r = g.type == CKEDITOR.NODE_ELEMENT ? g.getChild(e) : g.getNext();
                this._.guardLTR = function (a, b) {
                    return (!b || !h.equals(a)) && (!r || !a.equals(r)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            ...
            if (this.current)g = this.current[v](false, l, o); else {
                if (a)g.type ==
                CKEDITOR.NODE_ELEMENT && (g = e > 0 ? g.getChild(e - 1) : o(g, true) === false ? null : g.getPreviousSourceNode(true, l, o)); else {
                    g = d;
    ...
    (function () {
        ...
        var c = function (a) {
            ...
            a.optimizeBookmark();
            var g = a.startContainer, f = a.endContainer, e = a.startOffset, h = a.endOffset, m, j;
            ...
            var e = g.getParents(), h = f.getParents(), l, v, i;
            ...
            for (var r = c, k, H, n, C = l; C < e.length; C++) {
                ...
                for (k = k.getNext(); k;) {
                    ...
                    n = k.getNext();
                    if (b == 2)r.append(k.clone(true)); else {
                        k.remove();
                        b == 1 && r.append(k)
                    }
                    k = n
            ...
            for (c = l; c < h.length; c++) {
                ...
                if (!e[c] || k.$.parentNode != e[c].$.parentNode)for (k = k.getPrevious(); k;) {
                    ...
                    n = k.getPrevious();
                    if (b == 2)r.$.insertBefore(k.$.cloneNode(true), r.$.firstChild); else {
                        k.remove();
        ...
        CKEDITOR.dom.range.prototype =
        {
            ...
            switch (a) {
                ...
                case CKEDITOR.ENLARGE_ELEMENT:
                    ...
                    var f = this.getCommonAncestor(), e = this.root, k, m, j, l, v, h = false, r, i;
                        ...
                        for (; l;) {
                            ...
                            if (l.type == CKEDITOR.NODE_COMMENT)l = l.getPrevious(); else {
                                if (l.type == CKEDITOR.NODE_TEXT) {
                                    ...
                                    0 || b && l.is("br")) && !l.data("cke-bookmark"))if (h && CKEDITOR.dtd.$removeEmpty[l.getName()]) {
                                    i = l.getText();
                                    if (d.test(i))l = null; else for (var n = l.$.getElementsByTagName("*"), G = 0, C; C = n[G++];)if (!CKEDITOR.dtd.$removeEmpty[C.nodeName.toLowerCase()]) {
                                        l = null;
                                        break
                                    }
                                    l && (r = !!i.length)
            ...
            if (!this.collapsed) {
                var a = a || CKEDITOR.SHRINK_TEXT, d = this.clone(), g = this.startContainer, f = this.endContainer, e = this.startOffset, h = this.endOffset, m = 1, j = 1;
        ...
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                for (this._.nextNode = null; p;) {
                    var z = 0, A = p.hasAscendant("pre"), m = p.type != CKEDITOR.NODE_ELEMENT, j = 0;
                    if (m)p.type == CKEDITOR.NODE_TEXT && d.test(p.getText()) && (m = 0); else {
                        var l = p.getName();
                    ...
                    if (h && !z)for (; !p.getNext(n) && !s;) {
                        l = p.getParent();
                        if (l.isBlockBoundary(this.forceBrBreak && !A && {br: 1})) {
                            z = 1;
                            m = 0;
                            s || l.equals(g);
    ...
    (function () {
        function a(a, b, c, d, g) {
            ...
            for (f in b) {
                ...
                for (p in y) {
                    j[p] = h(j[p], m) || null;
                    var l = j, r = B[p], w = h(j[B[p]], m), t = j[p], v = [], i = true, k = void 0;
                    w ? i = false : w = {};
                    for (k in t)if (k.charAt(0) == "!") {
                        k = k.slice(1);
                        v.push(k);
                        w[k] = true;
                        i = false
        ...
        function u(a, b, d, g) {
            ...
            if (g.doCallbacks && a.elementCallbacks) {
                a:for (var m = a.elementCallbacks, l = 0, h = m.length, r; l < h; ++l)if (r = m[l](b)) {
                    j = r;
                    break a
                }
                if (j)return j
            ...
            if (g.doFilter) {
                a:{
                    ...
                    if (!a && !j)a = null; else {
                        ...
                        if (m) {
                            w = 0;
                            for (t = m.length; w < t; ++w)if (c(m[w], b, r) === false) {
                                a = null;
                                break a
                            }
                        }
                ...
                var i = a.validStyles;
                j = a.validClasses;
                var m = b.attributes, k = b.styles, l = b.classes, h = b.classBackup, B = b.styleBackup, y, x, N = [];
                r = [];
                var n = /^data-cke-/;
                w = false;
                delete m.style;
                ...
                if (!a.allAttributes)for (y in m)if (!t[y])if (n.test(y)) {
        ...
        function l(a, b, c) {
            var d = a.name;
            if (G.$empty[d] || !a.children.length)if (d == "hr" && b == "br")a.replaceWith(m()); else {
        ...
        function P(a, b) {
            var c = b.getDefinition(), d = c.attributes, g = c.styles, f, e, j, m;
            if (a.name != c.element)return false;
            for (f in d)if (f == "class") {
                c = d[f].split(/\s+/);
                for (j = a.classes.join("|"); m = c.pop();)if (j.indexOf(m) == -1)return false
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var g = this, f = [], e = this.editor && this.editor.config.protectedSource, j, m = false, p = {
                    doFilter: !c,
                    doTransform: true,
                    doCallbacks: true,
                    toHtml: b
                ...
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        a:{
                            ...
                            c = [];
                            var l, h, w;
                            if (e)for (h = 0; h < e.length; ++h)if ((w = d.match(e[h])) && w[0].length == d.length) {
                                c = true;
                                break a
                            }
                ...
                if (!this.disabled && a) {
                    ...
                    for (g = 0; g < a.length; ++g) {
                        b = a[g];
                        var f = void 0, e = void 0, j = void 0, m = void 0, l = void 0, p = void 0;
                        c = [];
                        for (e = 0; e < b.length; ++e) {
                            ...
                            c.push({check: m == f ? null : m, left: l, right: typeof p == "string" ? H(p) : p})
                        }
                        b = f;
                        d[b] || (d[b] = []);
                        d[b].push(c)
            ...
            check: function (a, b, c) {
                ...
                var e = CKEDITOR.tools.clone(g), j = [], m;
                if (b !== false && (m = this._.transformations[g.name])) {
                    for (d = 0; d < m.length; ++d)v(this, g, m[d]);
                    p(g)
                }
                u(this, e, j, {doFilter: true, doTransform: b !== false, skipRequired: !c, skipFinalValidation: !c});
                b = j.length > 0 ? false :
        ...
        var y = {styles: 1, attributes: 1, classes: 1}, B = {
            ...
            sizeToStyle: function (a) {
                ...
                if (typeof b == "string")a.name = b; else {
                    var c = b.getDefinition(), d = c.styles, g = c.attributes, f, e, j, m;
                    a.name = c.element;
        ...
        return function (b, c, d) {
            var f = {}, h = function (b) {
                a.call(this, b, function (a) {
                    ...
                    var b = [], n;
                    for (n in a) {
                        var s = a[n], q = s && s.requires;
                        if (!e[n]) {
                            if (s.icons)for (var u = s.icons.split(","), g = u.length; g--;)CKEDITOR.skin.addIcon(u[g], s.path + "icons/" + (CKEDITOR.env.hidpi && s.hidpi ? "hidpi/" : "") + u[g] + ".png");
                            e[n] = 1
                        }
                        if (q) {
                            q.split && (q = q.split(","));
    ...
    (function () {
        ...
        function o(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                a.plugins = c;
                for (var j in c) {
                    var m = c[j], h = m.lang, i = null, k = m.requires, t;
                    CKEDITOR.tools.isArray(k) && (k = k.join(","));
                    if (k && (t = k.match(l)))for (; k = t.pop();)CKEDITOR.tools.setTimeout(function (a, b) {
                    ...
                    if (h && !a.lang[j]) {
                        ...
                        if (!m.langEntries || !m.langEntries[i])e.push(CKEDITOR.getUrl(m.path + "lang/" + i + ".js")); else {
            ...
            function (f, h, n) {
                function i(a) {
                    ...
                    if (z.length > 0)for (var c = 0; c < z.length; c++) {
                        var d = z[c], f = d.name, e = CKEDITOR.dtd[f], g = m.name && CKEDITOR.dtd[m.name];
                ...
                var g = new CKEDITOR.htmlParser, p = h instanceof CKEDITOR.htmlParser.element ? h : typeof h == "string" ? new CKEDITOR.htmlParser.element(h) : new CKEDITOR.htmlParser.fragment, z = [], A = [], m = p, j = p.name == "textarea", l = p.name == "pre";
                    ...
                    if (a(f))z.push(f); else {
                        ...
                        if (d == "br")A.push(f); else {
                            for (; ;) {
                                ...
                                if (!f.isUnknown && !m.isUnknown && !p[d])if (m.isOptionalClose)g.onTagClose(h); else if (d in b && h in b) {
                                    h = m.children;
                                    (h = h[h.length - 1]) && h.name == "li" || s(h = new CKEDITOR.htmlParser.element("li"), m);
                                    !f.returnPoint && (f.returnPoint = m);
                                    m = h
                                } else if (d in CKEDITOR.dtd.$listItem && !u(d, h))g.onTagOpen(d == "li" ? "ul" : "dl", {}, 0, 1); else if (h in e && !u(d, h)) {
                                    !f.returnPoint && (f.returnPoint = m);
                                    m = m.parent
                                } else {
                ...
                g.onText = function (a) {
                    ...
                    var b = m.name, f = b ? CKEDITOR.dtd[b] || (m._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                    if (!j && !f["#"] && b in e) {
                        g.onTagOpen(d[b] || "");
                        g.onText(a)
                    } else {
    ...
    (function () {
        function a(a, e) {
                ...
                return function (e) {
                    if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if (m)for (t(m, 1) && j.push(m); m;) {
                            if (f(m) && (l = c(m)) && t(l))if ((w = c(l)) && !f(w))j.push(l); else {
                                g(p).insertAfter(l);
                                l.remove()
                            }
                            m = m.previous
            ...
            var r = {elements: {}}, p = e == "html", i = CKEDITOR.tools.extend({}, l), k;
        ...
        var z = /(?:&nbsp;|\xa0)$/, A = "{cke_protected}", m = CKEDITOR.dtd, j = ["caption", "colgroup", "col", "thead", "tfoot",
            "tbody"], l = CKEDITOR.tools.extend({}, m.$blockLimit, m.$block), v = {
            elements: {
                input: n,
                textarea: n
            }
        ...
        var H = /<(a|area|img|input|source)\b([^>]*)>/gi, G = /([\w-]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, C = /^(href|src|name)$/i, J = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
    ...
    (function () {
        ...
        function b(a) {
            var b = a.name, e = a.element, n = a.elementMode,
                i = a.fire("uiSpace", {space: "top", html: ""}).html, k = a.fire("uiSpace", {
                    space: "bottom",
                    html: ""
                }).html;
    ...
    (function () {
        function a(a) {
            var b = a.editor, d = a.data.path, f = d.blockLimit, m = a.data.selection, j = m.getRanges()[0], l;
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                focus: function () {
                    ...
                    var l = Array.prototype.slice.call(arguments, 1), l = a.on.apply(a, l);
                ...
                changeAttr: function (a, b) {
                    ...
                    if (!b) {
                        var e = /\n{2}/g;
                        if (e.test(a))var f = "<" + c + ">", l = "</" + c + ">", a = f + a.replace(e, function () {
                                return l + f
                            }) + l
                    }
                    a = a.replace(/\n/g, "<br>");
                    ...
                    var l, h;
                    if (f)for (; (l = b.getCommonAncestor(0, 1)) && (h = CKEDITOR.dtd[l.getName()]) && (!h || !h[e]);)if (l.getName()in CKEDITOR.dtd.span)b.splitElement(l); else if (b.checkStartOfBlock() && b.checkEndOfBlock()) {
                        b.setStartBefore(l);
                        b.collapse(true);
                        l.remove()
                    } else b.splitBlock(d ==
                    ...
                    if (!this.is("textarea")) {
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in m) {
                                var b = a.getSelection(), e, r = b.getRanges()[0], h = r.startPath(), i, k, p, c = c == 8;
                                if (CKEDITOR.env.ie && CKEDITOR.env.version < 11 && (e = b.getSelectedElement()) || (e = f(b))) {
                                    ...
                                    a.fire("saveSnapshot");
                                    d = 1
                                } else if (r.collapsed)if ((i = h.block) && (p = i[c ? "getPrevious" : "getNext"](o)) && p.type == CKEDITOR.NODE_ELEMENT && p.is("table") &&
        ...
        var i = CKEDITOR.dom.walker.bogus(), k = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi, o = CKEDITOR.dom.walker.whitespaces(true), s = CKEDITOR.dom.walker.bookmark(false, true);
        ...
        var q = function () {
            ...
            function b(c, d) {
                var e, f, j, m, t = [], r = d.range.startContainer;
                e = d.range.startPath();
                for (var r =
                    ...
                    if (a(e)) {
                        j = e.getName();
                        if (s && j in CKEDITOR.dtd.$list)t = t.concat(b(e, d)); else {
                            m = !!r[j];
            ...
            function d(b, c) {
                var e = [], f = b.getChildren(), j = f.count(), m, t = 0, r = l[c], h = !b.is(l.$inline) || b.is("br");
                for (h && e.push(" "); t < j; t++) {
                    m = f.getItem(t);
            ...
            var l = CKEDITOR.dtd, h = {
                p: 1, div: 1,
                h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1
            }, k = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, r = CKEDITOR.tools.extend({}, l.$inline);
            delete r.br;
            return function (h, i, v) {
                var o = h.editor;
                h.getDocument();
                var s = o.getSelection().getRanges()[0], q = false;
                ...
                if (!s.checkReadOnly()) {
                    ...
                    for (t = x.startNode; (t = t.getParent()) && e(t);)q.push(t);
                    o.moveToBookmark(x);
                    if (x = v) {
                        x = i.range;
                        ...
                        if (/^\s+|\s+$/.test(v) && "span"in CKEDITOR.dtd[w])var M = '<span data-cke-marker="1">&nbsp;</span>', v = M + v + M;
                    ...
                    if (x) {
                        D = i.range;
                        var M = D.document, u, v = i.blockLimit;
                        x = 0;
                        var I;
                        w = [];
                        var E, Q, q = o = 0, K, S;
                        ...
                        for (j(y, D); x < y.length; x++) {
                            ...
                            if (u = B.isLineBreak) {
                                ...
                                if (B.hasBlockSibling)u = 1; else {
                                    O = u.startContainer.getAscendant(l.$block, 1);
                                    if (!O || !O.is({div: 1, p: 1}))u = 0; else {
                                        W = O.getPosition(K);
                                        if (W == CKEDITOR.POSITION_IDENTICAL || W == CKEDITOR.POSITION_CONTAINS)u = 0; else {
                                            K = u.splitElement(O);
                                            u.moveToPosition(K,
                                                CKEDITOR.POSITION_AFTER_START);
                                            u = 1
                    ...
                    if (S)for (; E = S.pop();)CKEDITOR.env.needsBrFiller ? E.appendBogus() :
                    ...
                    if (!i.dontMoveCaret) {
                        for (E = a(I.startContainer) && I.startContainer.getChild(I.startOffset - 1); E && a(E) && !E.is(l.$empty);) {
                            if (E.isBlockBoundary())I.moveToPosition(E, CKEDITOR.POSITION_BEFORE_END); else {
            ...
            return function (d) {
                var e =
                    d.startContainer, f = e.getAscendant("table", 1), l = false;
                ...
                if (f.is("table")) {
                    ...
                    f.is({tbody: 1, thead: 1, tfoot: 1}) && (f = b(f, "tr", l));
    ...
    (function () {
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            d.on("contentDom", function () {
                var b = d.document, c = CKEDITOR.document, g = d.editable(), j = b.getBody(), m = b.getDocumentElement(), h = g.isInline(), i, o;
                    ...
                    var b = function (b, c) {
                        ...
                        for (var e = d.children, f, g, h = b.duplicate(), i = 0, m = e.length - 1, t = -1, l, k; i <= m;) {
                            ...
                            l = h.compareEndPoints("StartToStart",
                                b);
                            if (l > 0)m = t - 1; else if (l < 0)i = t + 1; else return {container: d, offset: a(f)}
                        }
                        ...
                        h = h.text.replace(/(\r\n|\r)/g, "\n").length;
                        if (!h)return {container: d, offset: a(f) + (l > 0 ? 0 : 1)};
                        for (; h > 0;)try {
                        ...
                        return {container: k, offset: l > 0 ? -h : k.nodeValue.length + h}
                    };
                    return function () {
    ...
    (function () {
        ...
        function e(b) {
            ...
            if (b.collapsed) {
                ...
                b.trim();
                var o = b.createBookmark(), l = o.startNode, m = o.endNode, n = l, p;
                if (!i) {
                    var q = b.getCommonAncestor(), i = a(l, q), q = a(m, q);
                ...
                for (n.getPosition(m) == CKEDITOR.POSITION_FOLLOWING && (n = 0); n;) {
                    ...
                    if (n.equals(m)) {
                        ...
                        var s = n.type == CKEDITOR.NODE_ELEMENT ? n.getName() : null, q = s && n.getAttribute("contentEditable") == "false", r = s && n.getAttribute("data-nostyle");
                        if (s && n.data("cke-bookmark")) {
                            n =
                                n.getNextSourceNode(true);
                            continue
                        }
                        if (q && k && CKEDITOR.dtd.$block[s])for (var v = n, A = c(v), C = void 0, H = A.length, P = 0, v = H && new CKEDITOR.dom.range(v.getDocument()); P < H; ++P) {
                        ...
                        if (A)if ((A = n.getParent()) && ((A.getDtd() || CKEDITOR.dtd.span)[f] || h) && (!g.parentRule || g.parentRule(A))) {
                            ...
                            if (s == CKEDITOR.NODE_TEXT || q || s == CKEDITOR.NODE_ELEMENT && !n.getChildCount()) {
                                for (var s = n, L; (i = !s.getNext(G)) && (L = s.getParent(), j[L.getName()]) && (L.getPosition(l) | F) == F && (!g.childRule || g.childRule(L));)s = L;
                                p.setEndAfter(s)
                            }
                    ...
                    if (i && p && !p.collapsed) {
                        for (var i = z(this, d), q = i.hasAttributes(), r = p.getCommonAncestor(), s = {}, A = {}, C = {}, H = {}, V, R, Y; i && r;) {
                            if (r.getName() == f) {
                                ...
                                for (R in g.styles)if (!C[R] && (Y = r.getStyle(R)))i.getStyle(R) == Y ? s[R] = 1 : C[R] = 1
                            }
                            r = r.getParent()
                        }
        ...
        function q(a, b) {
            ...
            for (h in d)if (!((h == "class" || this._.definition.fullMatch) && a.getAttribute(h) != l(h, d[h])) && !(b && h.slice(0, 5) == "data-")) {
                f = a.hasAttribute(h);
                a.removeAttribute(h)
            }
            for (var i in c)if (!(this._.definition.fullMatch && a.getStyle(i) != l(i, c[i], true))) {
                f = f || !!a.getStyle(i);
                a.removeStyle(i)
            }
            g(a, e, P[a.getName()]);
                ...
                renderHtml: function (a) {
                    ...
                    if (!this._.panel) {
                        var b = this._.panelDefinition,
                            d = this._.panelDefinition.block, i = b.parent || CKEDITOR.document.getBody(), h = "cke_combopanel__" + this.name, e = new CKEDITOR.ui.floatPanel(a, i, b), f = e.addListBlock(this.id, d), c = this;
                        e.onShow = function () {
        ...
        var j = CKEDITOR.tools.createClass({
            $: function (a) {
                ...
                setData: function (a, d) {
                    ...
                    var a =
                        this.editor, d = a.config, b = d.fullPage, c = b && a.docType, e = b && a.xmlDeclaration, g = this.getDocument(), b = b ? g.getDocumentElement().getOuterHtml() : g.getBody().getHtml();
    ...
    (function () {
        ...
        CKEDITOR.plugins.link = {
            getSelectedLink: function (c) {
                ...
                k = CKEDITOR.tools.extend({target: 1, onclick: 1, "data-cke-pa-onclick": 1, "data-cke-saved-name": 1},
                    j);
