...
<form action="?a=manage&m=add" method="post" name="add">
    <input type="hidden" name="flag" id="flag" value=""/>
    <dl class="form">
        <dd>用&nbsp;&nbsp;户&nbsp;&nbsp;名: <input type="text" name="user" id="user" class="text" onblur="checkUser();"/>&nbsp;&nbsp;&nbsp;&nbsp;(*
            2-20位之间)
        </dd>
        ...
        <dd><input type="submit" name="send" value="新增管理员" class="submit" onclick="return addManage();"/></dd>
    </dl>
</form>
